...
# January 15, 2010
#
# Goal: Variation of do_bit_trend, showing evolution of two bits
#       on the same plot
#
...
class do_bits_trend_plot(GenericWorker):
    ...
    def ProcessStop(self):
        ...
        tmp = "Beam gas rate evolution (in Hz/10^11p)"
        self.plot_name1 = "bits_history_%d_1" % (self.pixc)
        self.plot_name2 = "bits_history_%d_2" % (self.pixc)
